...
CGImageData::CGImageData(_CGSurfaceInfo* surfaceInfo) {
...
CGBitmapImage::CGBitmapImage(_CGSurfaceInfo* surfaceInfo) {
...
CGBitmapImageBacking::CGBitmapImageBacking(_CGSurfaceInfo* surfaceInfo) {
    _imageLocks = 0;
    _cairoLocks = 0;
...
void CGBitmapImageBacking::GetSurfaceInfoWithoutPixelPtr(_CGSurfaceInfo* surfaceInfo) {
